  ...
  return (
    <div style={{ padding: "20px" }}>
      ...
      <div className="input-container">
        <input type="number" placeholder="Nhập số tiền gửi" value={initialMoney} onChange={(e) => setInitialMoney(e.target.value)} />
        <input type="number" placeholder="Nhập lãi suất (%)" value={rate} onChange={(e) => setRate(e.target.value)} />
        <input type="number" placeholder="Nhập số tiền mong muốn" value={expectedMoney} onChange={(e) => setExpectedMoney(e.target.value)} />
